---
title: "Cleaning_CANTRIPS_03.01.2024"
...
readinallversions <- function(pattern, dataframe_name) {
  ...
  # Read in each CSV file into a separate dataframe
  dataframes_list <- lapply(file_list, function(file) {
    ...
    # Return the dataframe with an additional column for source file
  ...
  # Assign the combined and filtered dataframe to the specified name
...
# Example usage:
# readinallversions("-vlry.csv", "my_combined_dataframe")
# The resulting dataframe will be available as "my_combined_dataframe" in the global environment.
