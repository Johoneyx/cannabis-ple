...
select(UTC.Timestamp,UTC.Date.and.Time, Local.Timestamp, Local.Timezone, Local.Date.and.Time,, age, sex, country, education, occupation, mental_health_disorder, ethnicity) %>%View()
...
df_CEQ_CAPE_combined <- df_CAPE15_clean%>%
